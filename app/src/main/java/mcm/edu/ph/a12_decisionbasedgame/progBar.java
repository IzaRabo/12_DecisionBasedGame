...
public class progBar extends Animation {
    ...
    public progBar(Context context, TextView textView, android.widget.ProgressBar progressBar, float from, float to, Class nextActivity) {
